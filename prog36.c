...
#include <stdlib.h>
/***********************************************
 * Para rodar o programa usar o gcc no terminal *
 * gcc prog36.c -o prog36 c 0 100 10            *
 * Nos parâmetros passar qual será a conversão: *
 * c ou f, valor inicial, valor final e o step  *
 ***********************************************/
/*
C = (F - 32) / 1.8
F = (C * 1.8) + 32
...
int main(int argc, char *argv[])
{
    ...
    int min, max, step;
    // Se houver menos parâmentros do que o esperado, sai e mostra a ajuda:
    if (argc < 5)
        usage(argv[0]);
